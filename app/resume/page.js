export default function Resume() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-100 via-white to-gray-100">
      <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <header className="bg-black text-white text-center py-8">
          <img
            src="/POOH1.jpg"
            alt="Profile Picture"
            className="w-32 h-32 rounded-full mx-auto border-4 border-white mb-6 shadow-md"
          />
          <h1 className="text-4xl font-semibold">Aphiphu Thammetha</h1>
        ...
        <div className="px-10 py-8 space-y-8">
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-bold text-black border-b-4 pb-2 mb-4">ข้อมูลส่วนตัว</h2>
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-bold text-black border-b-4 pb-2 mb-4">ประวัติการศึกษาและประสบการณ์</h2>
          ...
          {/* Skills */}
          <section className="mb-8">
            <h2 className="text-3xl font-bold text-black border-b-4 pb-2 mb-4">ทักษะและความสามารถ</h2>
          ...
          {/* Achievements */}
          <section className="mb-8">
            <h2 className="text-3xl font-bold text-black border-b-4 pb-2 mb-4">ผลงานหรือความสำเร็จ</h2>
            <ul className="list-disc pl-6 space-y-3 text-gray-700 text-lg">
          ...
          {/* Special Traits */}
          <section>
            <h2 className="text-3xl font-bold text-black border-b-4 pb-2 mb-4">คุณสมบัติเฉพาะ</h2>
